...
Route::get('/admin/{adminin}/editit','tambah@edit')->name('post.edit');
Route::put('/admin/{adminin}/updatet','tambah@update')->name('post.update');
Route::delete('/admin/{adminin}/deletee','tambah@destroy')->name('post.destroy');
Route::post('/admin/masuk','LoginController@postlogin');
// Route::get('/form', 'FormController@rumahkan')->name('FormController.rumahkan');
